...
datasets = ['data/ar1.csv','data/ar3.csv']
for dataset in datasets:
	...
	for index in range(0,25):	
		...
		recall_for_diff_algos['minibatch'].append(recall(predicted_labels,test_label,True))
		fAlarm_for_diff_algos['minibatch'].append(falseAlarm(predicted_labels,test_label, True))
		...
		recall_for_diff_algos['kdTree'].append(recall(predicted_labels,test_label,True))
		fAlarm_for_diff_algos['kdTree'].append(falseAlarm(predicted_labels,test_label, True))

		start_time = time.time()
		predicted_labels = naiveBayes(train,test, train_label, test_label)
		nb_time += (time.time() - start_time)
		recall_for_diff_algos['nb'].append(recall(predicted_labels,test_label,True))
		fAlarm_for_diff_algos['nb'].append(falseAlarm(predicted_labels,test_label, True))
