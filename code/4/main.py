...
datasets = ['diabetes.csv','ivy-2.0.csv']
for dataset in datasets:
	...
	for index in range(0,25):	
		...
		recall_for_diff_algos['knn'].append( recall(knn_predicted_labels,test_label,1))
		fAlarm_for_diff_algos['knn'].append(falseAlarm(knn_predicted_labels,test_label, 1))

		start_time = time.time()
		predicted_labels = MiniBatch(train,test)
		minibatch_time += (time.time() - start_time)
		recall_for_diff_algos['minibatch'].append(recall(predicted_labels,test_label,1))
		fAlarm_for_diff_algos['minibatch'].append(falseAlarm(predicted_labels,test_label, 1))
		
		start_time = time.time()
		predicted_labels = kdTree(train,test)
		kdTree_time += (time.time() - start_time)
		recall_for_diff_algos['kdTree'].append(recall(predicted_labels,test_label,1))
		fAlarm_for_diff_algos['kdTree'].append( falseAlarm(predicted_labels,test_label, 1))
